...
export class MoneythorWidgetComponent {
  ...
  ngAfterViewInit() {
    ...
    if (this.parameters.language && this.parameters.language === 'fr') {
      classToShow = 'french';
      classToHide = 'english';
    }
    ...
    if (this.type === 'tip') {
      ...
      serviceData += switchLanguageCode;
      this.setInnerHTML(this.moneythorContainer.nativeElement, serviceData);
    }
